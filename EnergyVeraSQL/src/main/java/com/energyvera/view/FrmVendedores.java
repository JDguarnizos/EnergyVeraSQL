...
public class FrmVendedores extends javax.swing.JFrame {
    ...
    static private vendedorService vendorService;
    static private DefaultTableModel listaModelo;

    /**
     * Creates new form FrmClientes
     */
    public FrmVendedores(vendedorService vendorService) {
        initComponents();
    }
    ...
    private void Editar_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Editar_jButtonActionPerformed
        try {
            if (VistaFactVenta_jTable.getSelectedRow() == -1) {
                ...
                vendedor vendedorEditado = vendorService.buscarvendedorPorId(Integer.parseInt(VistaFactVenta_jTable.getValueAt(seleccionado, 0).toString()));

                FrmEditarCrearVendedor ventEditarFact = new FrmEditarCrearVendedor(vendedorEditado, vendorService);
    ...
    private void Anadir_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Anadir_jButtonActionPerformed
        vendedor facturaAnadir = null;
        FrmEditarCrearVendedor ventAnadirFact = new FrmEditarCrearVendedor(facturaAnadir,vendorService);
    ...
    /*
        Antes de hacer una locura, dejaré esto comentado hasta saber lo que escribí por wpp
        ...
        if (op == JOptionPane.YES_OPTION) {
            int seleccionado = VistaFactVenta_jTable.getSelectedRow();
            vendorService.(Integer.parseInt(VistaFactVenta_jTable.getValueAt(seleccionado, 0).toString()));
    ...
    public void mostrarListaClientes() {
        ...
        for (vendedor f : vendorService.listarFacturasVenta()) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVendedores(vendorService).setVisible(true);
            }
        });
